...
{`curl https://api.swipesblue.com/v1/payments \\
  ...
  -d description="Payment for order #1234"`}
      ...
      {/* Platforms Section - Triad Blue Ecosystem */}
      <section className="py-16 md:py-20 bg-swipes-gray-light border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-swipes-black mb-4">
              Platforms
            </h2>
            <p className="text-swipes-gray">
              Part of the Triad Blue ecosystem
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            ...
            <a 
              ...
              data-testid="link-platform-triadblue"
            >
              <img 
                src={triadBlueIcon} 
                alt="Triad Blue" 
                className="h-16 w-auto mb-3 group-hover:scale-105 transition-transform"
              />
              <div className="flex items-baseline">
                <span 
                  className="font-archivo-semi-expanded font-bold lowercase"
                  style={{ color: "#1844A6", fontSize: "16px" }}
                >
                  triad
                </span>
                <span 
            ...
            <Link 
              href="/"
              className="flex flex-col items-center text-center group"
              data-testid="link-platform-swipesblue"
            >
              <img 
                src={swipesBlueIcon} 
                alt="SwipesBlue" 
            ...
            <a 
              ...
              rel="noopener noreferrer"
              className="flex flex-col items-center text-center group"
              data-testid="link-platform-hostsblue"
            >
              <img 
                src={hostsBlueIcon} 
                alt="HostsBlue" 
              ...
              <div className="flex items-baseline">
                <span 
                  className="font-archivo-semi-expanded font-bold lowercase"
                  style={{ color: "#008060", fontSize: "16px" }}
                >
                  hosts
                </span>
                <span 
            ...
            <a 
              ...
              rel="noopener noreferrer"
              className="flex flex-col items-center text-center group"
              data-testid="link-platform-businessblueprint"
            >
              <img 
                src={businessBlueprintIcon} 
                alt="BusinessBlueprint" 
                className="h-16 w-auto mb-3 group-hover:scale-105 transition-transform"
              />
              <div className="flex items-baseline">
                <span 
