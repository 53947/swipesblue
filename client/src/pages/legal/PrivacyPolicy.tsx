    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.1. Information You Provide Directly:</h3>
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.2. Information Collected About Your Customers:</h3>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.3. Information Collected Automatically:</h3>
          <ul className="list-disc pl-6 text-gray-500 text-base leading-relaxed mb-4 space-y-1">
            ...
            <li>Cookie data (see our <Link href="/cookies" className="text-[#1844A6] hover:underline">Cookie Policy</Link> for details)</li>
          </ul>

          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.4. Information from Third Parties:</h3>
          <ul className="list-disc pl-6 text-gray-500 text-base leading-relaxed mb-4 space-y-1">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">4. How We Share Your Information</h2>

          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">4.1. Payment Processing Partners:</h3>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
            ...
            <a href="https://www.nmi.com/privacy/" target="_blank" rel="noopener noreferrer" className="text-[#1844A6] hover:underline">https://www.nmi.com/privacy/</a>. Banking services are provided by Merrick Bank, Member FDIC.
          </p>

          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">4.2. Payment Networks:</h3>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">4.3. triadblue Ecosystem:</h3>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">4.4. Service Providers:</h3>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">4.5. Legal Requirements:</h3>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">4.6. Business Transfers:</h3>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">7. Your Rights and Choices</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">8. California Privacy Rights (CCPA/CPRA)</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">9. European Privacy Rights (GDPR)</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
