    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        <div className="prose prose-gray max-w-none">
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">1. Introduction and Acceptance</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">4. Account Registration and Security</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">5. Payment Processing</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
            ...
            <a href="https://www.nmi.com/policy/" target="_blank" rel="noopener noreferrer" className="text-[#1844A6] hover:underline">https://www.nmi.com/policy/</a>.
          </p>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">6. Fees and Billing</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">7. Compliance with Laws and Payment Network Rules</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">8. Data Security and PCI Compliance</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">10. Prohibited Activities</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <p className="text-gray-500 text-base leading-relaxed mb-4">
            ...
            <Link href="/acceptable-use" className="text-[#1844A6] hover:underline">Acceptable Use Policy</Link>.
          </p>

          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">11. Limitation of Liability</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4 uppercase font-medium">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">14. Modifications to Terms</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">15. Governing Law and Dispute Resolution</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
