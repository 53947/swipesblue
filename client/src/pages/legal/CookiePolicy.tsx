  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-8 py-16">
        <h1 className="text-3xl font-bold text-swipes-black mb-2">Cookie Policy</h1>
        <p className="text-sm text-gray-400 mb-8">Last Updated: February 6, 2026</p>

        <div className="prose prose-gray max-w-none">
          <h2 className="text-xl font-semibold text-swipes-black mt-8 mb-4">1. What Are Cookies</h2>
          ...
          <h2 className="text-xl font-semibold text-swipes-black mt-8 mb-4">2. How We Use Cookies</h2>
          <p className="text-swipes-pro-gray text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-swipes-black mt-8 mb-4">3. Types of Cookies We Use</h2>

          <h3 className="text-lg font-medium text-swipes-black mt-6 mb-3">3.1. Essential Cookies (Required)</h3>
          <p className="text-swipes-pro-gray text-base leading-relaxed mb-4">
          ...
          <h3 className="text-lg font-medium text-swipes-black mt-6 mb-3">3.2. Functional Cookies</h3>
          <p className="text-swipes-pro-gray text-base leading-relaxed mb-4">
          ...
          <h3 className="text-lg font-medium text-swipes-black mt-6 mb-3">3.3. Analytics Cookies</h3>
          <p className="text-swipes-pro-gray text-base leading-relaxed mb-4">
          ...
          <h3 className="text-lg font-medium text-swipes-black mt-6 mb-3">3.4. Payment Processing Cookies</h3>
          <p className="text-swipes-pro-gray text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-swipes-black mt-8 mb-4">4. Third-Party Cookies</h2>
          <p className="text-swipes-pro-gray text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-swipes-black mt-8 mb-4">5. Your Cookie Choices</h2>
          <p className="text-swipes-pro-gray text-base leading-relaxed mb-4">
          ...
          <ul className="list-disc pl-6 text-swipes-pro-gray text-base leading-relaxed mb-4 space-y-1">
            <li>Google Analytics:{" "}
              <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-swipes-blue-deep hover:underline">https://tools.google.com/dlpage/gaoptout</a>
            </li>
          </ul>

          <h2 className="text-xl font-semibold text-swipes-black mt-8 mb-4">6. Do Not Track Signals</h2>
          <p className="text-swipes-pro-gray text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-swipes-black mt-8 mb-4">7. Changes to This Cookie Policy</h2>
          <p className="text-swipes-pro-gray text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-swipes-black mt-8 mb-4">8. Contact Us</h2>
          <p className="text-swipes-pro-gray text-base leading-relaxed mb-4">
