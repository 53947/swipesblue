      ...
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <p className="text-gray-500 text-base leading-relaxed mb-4">
            ...
            <Link href="/terms" className="text-[#1844A6] hover:underline">Terms of Service</Link>. By using swipesblue, you agree to comply with this AUP.
          </p>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">2. Prohibited Activities</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
            You may not use swipesblue's Services to process payments for, facilitate, or engage in any of the following:
          </p>

          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.1. Illegal Products and Services:</h3>
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.2. Regulated or High-Risk Activities (without prior approval):</h3>
          <ul className="list-disc pl-6 text-gray-500 text-base leading-relaxed mb-4 space-y-1">
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.3. Fraudulent or Deceptive Practices:</h3>
          <ul className="list-disc pl-6 text-gray-500 text-base leading-relaxed mb-4 space-y-1">
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.4. Financial Crimes:</h3>
          <ul className="list-disc pl-6 text-gray-500 text-base leading-relaxed mb-4 space-y-1">
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.5. Harmful Content or Activities:</h3>
          <ul className="list-disc pl-6 text-gray-500 text-base leading-relaxed mb-4 space-y-1">
          ...
          <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.6. Payment Network Violations:</h3>
          <ul className="list-disc pl-6 text-gray-500 text-base leading-relaxed mb-4 space-y-1">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">3. Restricted Business Categories</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">4. Your Responsibilities</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">5. Enforcement</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-4">
